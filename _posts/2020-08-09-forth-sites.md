...
## [An Introduction to Forth Using StackFlow](https://www.taygeta.com/forth_intro/stackflo.html)
...
[Страница Бреда Нельсона](http://bradn123.github.io/). Это GitHub с проектами некоего Бреда Нельсона. Есть даже форт-слова для рендеринга. 

[Форт хайку](https://forthsalon.appspot.com/). Очень интересный своей выразительности проект. Очень короткими программами можно создавать очень интересные визуальные эффекты. Это специализированная реализация Форт [словарь](https://forthsalon.appspot.com/word-list) которой предусматривает обработку шрейдеров. С их помощью можно создавать визуальные эффекты и игры. Нужно заметить, никаких спрайтов там нет. Все кадры генерируются во время исполнения кода, как в старинных игровых консолях Atari. Стоит изучить код - это образец минимализма в программировании. Одна проблема - я не понимаю, как эти Хайку работают. 

[Forth Information on Taygeta](https://www.taygeta.com/forth.html). Чудом продолжающий жить ресурс по Форт. Видимо, это чья-то небольшая IT фирма. Многие, если не большинство ссылок уже "мёртвые". Система, в основном, отсутствует. Как, впрочем, и в этой моей странице. Но если начинать бродить по ссылкам с этой точки - можно найти интересные материалы про Форт.

[Forth Literature and Education](https://www.taygeta.com/forthlit.html). Это раздел сайта Taygeta, см. выше. Ещё больше битых ссылок и меньше системы.

[Links to Forth programs](https://www.complang.tuwien.ac.at/forth/program-links.html). Пример удивительного соответствия формы названию. Это действительно набор ссылок на различные программы на Форте. Хотя очень много ссылок уже мёртвые, ещё можно найти "настоящие", а не учебные программы для Форт.

[Страница Albert Nijhof про Форт](https://home.hccnet.nl/anij/index.html). Очевидно, страница какого-то норвежского энтузиаста Форт. Я бы не стал приводить её здесь, не будь страница удивительно живая. Последнее обновление в прошлом году. По меркам Форта - это очень актуальный ресурс.

[DNW's Forth Page](http://www-personal.umich.edu/~williams/archive/forth/forth.html). Ещё одна страница энтузиаста Форт с интересными ссылками. Я имею в виду - реально интересными. Структуры данных в Форт, новые управляющие структуры и много всего другого. Кроме того, многие материалы хранятся в архиве автора, поэтому битых ссылок относительно немного.

[comp.lang.forth](https://groups.google.com/g/comp.lang.forth). Это конференция по языку Форт. Возможно, это последнее место, где теплится жизнь, идут обсуждения. Язык - английский. За, предположительно три десятилетия существования новостной конференции в ней накопилось 25000 тем. Значит возникает примерно по одной новой теме каждые два дня. Больше общаться с единомышленниками всё равно негде. Имея аккаунт Google можно писать и читать эту конференцию. 